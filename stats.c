...
/*   Updated: 2022/06/13 12:07:45 by bahaas           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
*/
double get_mdev(t_params *params)
{
	double mdev;
	double avg;
	double avg_square;
...
int print_stats(t_params *params)
{
	long time;
	double mdev;
	...
	printf("rtt min/avg/max/mdev = %.3lf/%.3lf/%.3lf/%.3lf ms\n", params->time.min, params->time.avg, params->time.max, get_mdev(params));
	return (true);
}
